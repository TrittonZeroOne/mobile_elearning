          ...
          children: [
            ...
            Center(
              child: CircleAvatar(
                ...
                child: Text(
                  (_profile!['full_name'] as String? ?? 'G').isNotEmpty
            ...
            Center(
              child: Container(
                ...
                child: const Text("GURU", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              ),
            ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon: Icon(_editing ? Icons.close : Icons.edit, color: Colors.green),
                    ...
                    const SizedBox(height: 12),
                    _InfoRow(icon: Icons.badge, label: "Role", value: "Guru"),
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: CircleAvatar(
        ...
        child: Icon(
          _theme.isDark ? Icons.dark_mode : Icons.light_mode,
